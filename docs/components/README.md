...
| 16 | [Variable Management & Power Fx](16-variable-management.md) | Variable Scopes (Topic/Global), Data Types, Power Fx manipulation, Passing variables | How do I store and manipulate data, memory, and context? |
